...
typedef NS_ENUM(NSInteger, UIImageBlurType) {
    UIImageBlurTypeNone,
    UIImageBlurTypeExtraLight,
    UIImageBlurTypeLight,
    UIImageBlurTypeDark
};

@interface UIImage (UIImageEffects)

- (UIImage*)blurredImageWithBlurType:(UIImageBlurType)blurType;
...
- (UIImage*)blurImageWithWithRadius:(CGFloat)blurRadius tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage;
